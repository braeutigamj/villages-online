...
<?
$result = $db->fetch("SELECT id,name,x,y,(sqrt((x - ".$village['x'].") * (x - ".$village['x'].") + (y - ".$village['y'].") * (y - ".$village['y']."))) AS distance FROM village WHERE userid = '$id' ORDER BY distance ASC");
$i = 0;
